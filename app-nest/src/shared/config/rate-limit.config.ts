...
export const rateLimitConfig = registerAs("rateLimit", () => ({
  ...
  authRegisterPerHourPerIp: getInt("RL_AUTH_REGISTER_PER_HOUR_PER_IP", 10),
  authRegisterPerHourPerEmail: getInt("RL_AUTH_REGISTER_PER_HOUR_PER_EMAIL", 3),
  authRegisterConfirmPer10MinPerIp: getInt("RL_AUTH_REGISTER_CONFIRM_PER_10MIN_PER_IP", 30),
  authRegisterConfirmPer10MinPerToken: getInt(
